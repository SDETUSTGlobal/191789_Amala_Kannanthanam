...
driver.find_element_by_name("ctl00$MainContent$fmwOrder$txtName").send_keys("Amala");
driver.find_element_by_id("ctl00_MainContent_fmwOrder_TextBox2").send_keys("manimala");
